...
day = 86400
--*********BOT ID*******--
bot_id = 352191187 -- [[محل قرار گیری آیدی اکانت ربات]]
--**********************--
--*********SUDO ID*******--
sudo_users = {170146015,204507468} -- [[محل قرار گیری آیدی سودو ها]]
--***********************--
--********BOT OWNER******--
bot_owner = 170146015 -- [[ محل قرار گیری آیدی مدیر اصلی ربات ]]
--***********************--
-----------------------------------------------------------------------------------------------
---------------
-- Start Functions --
